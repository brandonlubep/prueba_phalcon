...
class CompaniesController extends ControllerBase
{
    ...
    public function editAction($id)
    {
        ...
        if (!$request->isPost()) {
            ...
            Tag::displayTo("type", $companies->type);
            Tag::displayTo("actor", $companies->actor);
            Tag::displayTo("director", $companies->director);
        }
    }
    ...
    public function createAction()
    {
        ...
        $companies->type = $this->request->getPost("type", "striptags");
        $companies->actor = $this->request->getPost("actor", "striptags");
        $companies->director = $this->request->getPost("director", "striptags");
